...
\affiliation{Wydział Fizyki Uniwersytetu Warszawskiego}
\email{w.noskowiak@student.uw.edu.pl}

\shortauthors{W. Noskowiak}
...
Celem ćwiczenia było zbadanie stężenia *insert gaz here* w różnych próbkach powietrza. Wartośći stężeń uzyskałem poprzez analizę wyników pomiarów przeprowadzonych przez innych studentów. przekazane mi dane przebadałem w opariu o polecenia z instrukcji, materiały dostępne na stronie pracowni oraz dokumenty przekazane przez prowadzącego ćwiczenie. Przekazane mi dane przeanalizowałem programem napisanym przeze mnie w języku python. 
